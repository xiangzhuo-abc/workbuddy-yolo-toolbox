...
python tools/build_runtime.py --profile cpu --clean --out-dir tmp\runtime-candidate --base-url "https://你的发布站点/runtime-r1"
```
...
python tools/build_runtime.py --profile cuda118 --clean --out-dir tmp\runtime-candidate --base-url "https://你的发布站点/runtime-r1"
```
...
```powershell
python tools/build_installer.py --exe-dir tmp\exe-candidate --out-dir tmp\installer-candidate --official-release --source-url "https://你的公开仓库/对应版本"
```
